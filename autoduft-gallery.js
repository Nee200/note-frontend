'use strict';
window.NoteAutoduftGallery = function ({ lock, unlock }) {
    const thumbnails = [...document.querySelectorAll('[data-gallery-src]')];
    const mainImage = document.getElementById('autoduft-main-image');
    ...
    // All four images use the optimized asset URLs; no PNG redirect during a gesture.
